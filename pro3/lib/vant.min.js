!function (t, e) {
     ...
     */
        ...
        var E = Object(r.a)("overlay"), D = E[0], M = E[1];
        ...
        function P(t, e, i, s) {
            ...
            return Object(I.b)(e.duration) && (r.animationDuration = e.duration + "s"), t("transition", {attrs: {name: "van-fade"}}, [t("div", o()([{
                directives: [{
                    name: "show",
                    value: e.show
                }], style: r, class: [M(), e.className], on: {touchmove: F}
        ...
        var V, R = D(P), _ = {className: "", customStyle: {}};
        ...
        function W() {
            if (V || (V = f(R, {on: {click: H}})), C.top) {
                var t = C.top, e = t.vm, i = t.config, s = e.$el;
                s && s.parentNode ? s.parentNode.insertBefore(V.$el, s) : document.body.appendChild(V.$el), n(V, _, i, {show: !0})
            } else V.show = !1
        }

        function q(t) {
            var e = C.stack;
            e.length && (C.top.vm === t ? (e.pop(), W()) : C.stack = e.filter(function (e) {
                return e.vm !== t
            }))
        }
        ...
        function G(t) {
            K(window, t), K(document.body, t)
        }

        function Z(t) {
            return (t === window ? 0 : t.getBoundingClientRect().top) + Q()
        }
        ...
        var J = {
            ...
            methods: {
                open: function () {
                    ...
                    this.opened && (this.lockScroll && (C.lockCount--, A(document, "touchstart", this.touchStart), A(document, "touchmove", this.onTouchMove), C.lockCount || document.body.classList.remove("van-overflow-hidden")), this.opened = !1, q(this), this.$emit("input", !1))
                }, onTouchMove: function (t) {
                    this.touchMove(t);
                    var e = this.deltaY > 0 ? "10" : "01", i = U(t.target, this.$el), n = i.scrollHeight,
                    ...
                    !this.$isServer && this.value && this.$nextTick(function () {
                        ...
                        t.updateZIndex(t.overlay ? 1 : 0), t.overlay ? (e = t, i = {
                            ...
                            return t.vm === e
                        }) || (C.stack.push({vm: e, config: i}), W())) : q(t)
                    })
                }, updateZIndex: function (t) {
                    void 0 === t && (t = 0), this.$el.style.zIndex = ++C.zIndex + t
                }
            }
        }, tt = i(8), et = Object(r.a)("info"), it = et[0], nt = et[1];

        function st(t, e, i, n) {
            var s = e.dot, r = e.info, a = Object(I.b)(r) && "" !== r;
            if (s || a) return t("div", o()([{class: nt({dot: s})}, h(n, !0)]), [s ? "" : e.info])
        }

        st.props = {dot: Boolean, info: [Number, String]};
        var ot = it(st), rt = Object(r.a)("image"), at = rt[0], lt = rt[1], ut = at({
            props: {
                src: String,
                fit: String,
                alt: String,
                ...
                style: function () {
                    var t = {};
                    return Object(I.b)(this.width) && (t.width = Object(tt.a)(this.width)), Object(I.b)(this.height) && (t.height = Object(tt.a)(this.height)), Object(I.b)(this.radius) && (t.overflow = "hidden", t.borderRadius = Object(tt.a)(this.radius)), t
                }
            }, created: function () {
                var t = this.$Lazyload;
                ...
                onLoad: function (t) {
                    ...
                    return this.loading && this.showLoading ? t("div", {class: lt("loading")}, [this.slots("loading") || t(pt, {
                        attrs: {
                            name: "photo-o",
                            size: "22"
                        }
                    })]) : this.error && this.showError ? t("div", {class: lt("error")}, [this.slots("error") || t(pt, {
                        attrs: {
                            name: "warning-o",
                            size: "22"
                        }
                    ...
                    var t = this.$createElement,
                        e = {class: lt("img"), attrs: {alt: this.alt}, style: {objectFit: this.fit}};
                ...
                var t = arguments[0];
                return t("div", {
                    class: lt({round: this.round}),
                    style: this.style,
                    on: {click: this.onClick}
                }, [this.renderImage(), this.renderPlaceholder()])
            }
        }), ct = Object(r.a)("icon"), ht = ct[0], dt = ct[1];

        function ft(t, e, i, n) {
            var s, r = !!(s = e.name) && -1 !== s.indexOf("/");
            return t(e.tag, o()([{
                class: [e.classPrefix, r ? "" : e.classPrefix + "-" + e.name],
                style: {color: e.color, fontSize: Object(tt.a)(e.size)}
            }, h(n, !0)]), [i.default && i.default(), r && t(ut, {
                class: dt("image"),
                attrs: {fit: "contain", src: e.name, showLoading: !1}
            }), t(ot, {attrs: {dot: e.dot, info: e.info}})])
        }
        ...
        ft.props = {
            ...
            classPrefix: {type: String, default: dt()}
        };
        var pt = ht(ft), mt = Object(r.a)("popup"), vt = mt[0], gt = mt[1], bt = vt({
            mixins: [J],
            props: {
                round: Boolean,
                duration: Number,
            ...
            render: function () {
                ...
                if (this.shouldRender) {
                    ...
                    return Object(I.b)(s) && (r.transitionDuration = s + "s"), e("transition", {
                        ...
                        style: r,
                        class: gt((t = {round: i}, t[n] = n, t["safe-area-inset-bottom"] = this.safeAreaInsetBottom, t)),
                        on: {click: this.onClick}
                    }, [this.slots(), this.closeable && e(pt, {
                        attrs: {
                            role: "button",
                            tabindex: "0",
                            name: this.closeIcon
                        }, class: gt("close-icon", this.closeIconPosition), on: {click: this.close}
                    })])])
                }
            }
        }), yt = Object(r.a)("loading"), kt = yt[0], St = yt[1];
        ...
        function xt(t, e) {
            ...
            return t("svg", {class: St("circular"), attrs: {viewBox: "25 25 50 50"}}, [t("circle", {
                attrs: {
                    cx: "50",
                    cy: "50",
                    r: "20",
        ...
        function wt(t, e, i) {
            if (i.default) {
                var n = e.textSize && {fontSize: Object(tt.a)(e.textSize)};
                return t("span", {class: St("text"), style: n}, [i.default()])
            }
        }
        ...
        function Ct(t, e, i, n) {
            ...
            return t("div", o()([{class: St([a, {vertical: e.vertical}])}, h(n, !0)]), [t("span", {
                class: St("spinner", a),
                style: l
            }, [xt(t, e)]), wt(t, e, i)])
        }
        ...
        var Ot = kt(Ct), Tt = Object(r.a)("action-sheet"), $t = Tt[0], It = Tt[1];
        ...
        function Bt(t, e, i, n) {
            ...
            var l = e.description && t("div", {class: It("description")}, [e.description]);
            return t(bt, o()([{
                class: It(),
                attrs: {
                    position: "bottom",
                ...
                if (s) return t("div", {class: [It("header"), S]}, [s, t(pt, {
                    attrs: {name: "close"},
                    class: It("close"),
                    on: {click: a}
                })])
                ...
                return t("button", {
                    class: [It("item", {disabled: o}), i.className, y],
                    style: {color: i.color},
                    on: {
                        click: function (t) {
                ...
                }, [i.loading ? t(Ot, {attrs: {size: "20px"}}) : [t("span", {class: It("name")}, [i.name]), i.subname && t("span", {class: It("subname")}, [i.subname])]])
            }), function () {
                if (i.default) return t("div", {class: It("content")}, [i.default()])
            }(), function () {
                if (r) return t("button", {class: It("cancel"), on: {click: a}}, [r])
            }()])
        }
        ...
        var Dt = Object(r.a)("picker-column"), Mt = Dt[0], Ft = Dt[1];
        ...
        var Vt = Mt({
            ...
            methods: {
                onTouchStart: function (t) {
                    ...
                    this.moving = !0, this.touchMove(t), "vertical" === this.direction && L(t, !0), this.offset = Et(this.startOffset + this.deltaY, -this.count * this.itemHeight, this.itemHeight);
                    var e = Date.now();
                    ...
                    for (var e = t = Et(t, 0, this.count); e < this.count; e++) if (!Pt(this.options[e])) return e;
                    for (var i = t - 1; i >= 0; i--) if (!Pt(this.options[i])) return i
                    ...
                    return this.options.map(function (n, s) {
                        var r = t.getOptionText(n), a = Pt(n), l = {
                            style: i,
                            attrs: {role: "button", tabindex: a ? -1 : 0},
                            class: ["van-ellipsis", Ft("item", {disabled: a, selected: s === t.currentIndex})],
                            on: {
                                click: function () {
                                    t.onClickItem(s)
                                }
        ...
        }), Rt = Object(r.a)("picker"), _t = Rt[0], Ht = Rt[1], Wt = Rt[2], qt = _t({
            props: n({}, Lt, {
                ...
                var e = this, i = this.itemHeight, n = i * this.visibleItemCount,
                    ...
                    l = this.showToolbar && t("div", {class: [w, Ht("toolbar")]}, [this.slots() || [t("button", {
                        class: Ht("cancel"),
                        on: {click: this.onCancel}
                    }, [this.cancelButtonText || Wt("cancel")]), this.slots("title") || this.title && t("div", {class: ["van-ellipsis", Ht("title")]}, [this.title]), t("button", {
                        class: Ht("confirm"),
                        on: {click: this.onConfirm}
                    }, [this.confirmButtonText || Wt("confirm")])]]);
                return t("div", {class: Ht()}, ["top" === this.toolbarPosition ? l : t(), this.loading ? t(Ot, {class: Ht("loading")}) : t(), this.slots("columns-top"), t("div", {
                    class: Ht("columns"),
                    style: r,
                    on: {touchmove: L}
                }, [s.map(function (i, n) {
                    ...
                    class: ["van-hairline-unset--top-bottom", Ht("frame")],
                    style: o
                })]), this.slots("columns-bottom"), "bottom" === this.toolbarPosition ? l : t()])
            }
        }), Yt = Object(r.a)("area"), Ut = Yt[0], Xt = Yt[1];
        var Kt = Ut({
            props: n({}, Lt, {
                value: String,
                areaList: {
        ...
        var Jt = {url: String, replace: Boolean, to: [String, Object]}, te = Object(r.a)("cell"), ee = te[0],
            ie = te[1];
        ...
        function ne(t, e, i, n) {
            var s = e.icon, r = e.size, a = e.title, l = e.label, u = e.value, c = e.isLink, f = e.arrowDirection,
                ...
                v = (i.label || Object(I.b)(l)) && t("div", {class: [ie("label"), e.labelClass]}, [i.label ? i.label() : l]),
                g = p && t("div", {
                    class: [ie("title"), e.titleClass],
                    style: e.titleStyle
                }, [i.title ? i.title() : t("span", [a]), v]),
                b = m && t("div", {class: [ie("value", {alone: !i.title && !a}), e.valueClass]}, [i.default ? i.default() : t("span", [u])]),
                y = i.icon ? i.icon() : s && t(pt, {class: ie("left-icon"), attrs: {name: s}}), k = i["right-icon"],
                S = k ? k() : c && t(pt, {class: ie("right-icon"), attrs: {name: f ? "arrow-" + f : "arrow"}});
        ...
        ne.props = n({}, Qt, {}, Jt);
        var se = ee(ne);
        var oe = !I.d && /ios|iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase());

        function re() {
            oe && G(Q())
        }

        var ae = Object(r.a)("field"), le = ae[0], ue = ae[1], ce = le({
            inheritAttrs: !1,
            props: n({}, Qt, {
                error: Boolean,
                readonly: Boolean,
            ...
            computed: {
                showClear: function () {
                    ...
                    if (t) return {width: Object(tt.a)(t)}
                }
            },
            methods: {
                focus: function () {
                    ...
                    this.focused = !1, this.$emit("blur", t), re()
                }, onClick: function (t) {
                    this.$emit("click", t)
                    ...
                    if (e) return t("div", {class: ue("control", this.inputAlign)}, [e]);
                    var i = {
                        ref: "input",
                        class: ue("control", this.inputAlign),
                    ...
                    }, [this.slots("left-icon") || t(pt, {attrs: {name: this.leftIcon}})])
                    ...
                    }, [e("right-icon") || t(pt, {attrs: {name: this.rightIcon}})])
                }, renderWordLimit: function () {
                    var t = this.$createElement;
                    if (this.showWordLimit && this.$attrs.maxlength) return t("div", {class: ue("word-limit")}, [this.value.length, "/", this.$attrs.maxlength])
                }
            },
            render: function () {
                ...
                return i("label") && (s.title = function () {
                    ...
                    attrs: {
                        ...
                        titleClass: [ue("label", n), this.labelClass],
                        arrowDirection: this.arrowDirection
                    },
                    class: ue((t = {error: this.error}, t["label-" + n] = n, t["min-height"] = "textarea" === this.type && !this.autosize, t)),
                    scopedSlots: s,
                    on: {click: this.onClick}
                }, [e("div", {class: ue("body")}, [this.renderInput(), this.showClear && e(pt, {
                    attrs: {name: "clear"},
                    class: ue("clear"),
                    on: {touchstart: this.onClear}
                }), this.renderRightIcon(), i("button") && e("div", {class: ue("button")}, [i("button")])]), this.renderWordLimit(), this.errorMessage && e("div", {class: ue("error-message", this.errorMessageAlign)}, [this.errorMessage])])
            }
        }), he = Object(r.a)("toast"), de = he[0], fe = he[1], pe = de({
            mixins: [J],
            props: {
                icon: String,
                className: null,
        ...
        function ke(t) {
            ...
            return e.value && e.updateZIndex(), t = n({}, be, {}, ye(t), {
                clear: function () {
                    e.value = !1, t.onClose && t.onClose(), ge && !I.d && e.$on("closed", function () {
        ...
        }, ke.setDefaultOptions = function (t) {
            n(be, t)
        }, ke.resetDefaultOptions = function () {
            be = n({}, me)
        ...
        var Se = ke, xe = Object(r.a)("button"), we = xe[0], Ce = xe[1];
        ...
        function Oe(t, e, i, n) {
            ...
            return t(r, o()([{
                ...
                attrs: {name: a},
                class: Ce("icon")
            })), (y = p ? g : i.default ? i.default() : e.text) && k.push(t("span", {class: Ce("text")}, [y])), k)])
        }
        ...
        }), je = Object(r.a)("dialog"), Ne = je[0], Ae = je[1], ze = je[2], Le = Ne({
            mixins: [J, Be],
            props: {
                title: String,
                width: [Number, String],
            ...
            render: function () {
                ...
                if (this.shouldRender) {
                    var s = this.message, o = this.messageAlign, r = this.slots(),
                        ...
                        l = a && n("div", {class: Ae("header", {isolated: !s && !r})}, [a]),
                        u = (r || s) && n("div", {class: Ae("content")}, [r || n("div", {
                            domProps: {innerHTML: s},
                            class: Ae("message", (t = {"has-title": a}, t[o] = o, t))
                        })]), c = this.showCancelButton && this.showConfirmButton,
                        h = n("div", {class: [y, Ae("footer", {buttons: c})]}, [this.showCancelButton && n(Te, {
                            attrs: {
                                size: "large",
                                loading: this.loading.cancel,
                                text: this.cancelButtonText || ze("cancel")
                            }, class: Ae("cancel"), style: {color: this.cancelButtonColor}, on: {
                                click: function () {
                                    i.handleAction("cancel")
                                }
                            }
                        }), this.showConfirmButton && n(Te, {
                            attrs: {
                                size: "large",
                                loading: this.loading.confirm,
                                text: this.confirmButtonText || ze("confirm")
                            },
                            class: [Ae("confirm"), (e = {}, e[k] = c, e)],
                    ...
                    return n("transition", {
                        ...
                        class: [Ae(), this.className],
                        style: {width: Object(tt.a)(this.width)}
                    }, [l, u, h])])
                }
            }
        });
        ...
        function Ee(t) {
            return I.d ? Promise.resolve() : new Promise(function (e, i) {
                var s;
                Ie && (s = Ie.$el, document.body.contains(s)) || (Ie && Ie.$destroy(), (Ie = new (l.a.extend(Le))({
                    el: document.createElement("div"),
                    propsData: {lazyRender: !1}
                })).$on("input", function (t) {
                    Ie.value = t
                })), n(Ie, Ee.currentOptions, t, {resolve: e, reject: i})
            })
        }
        ...
        Ee.defaultOptions = {
            ...
            callback: function (t) {
                Ie["confirm" === t ? "resolve" : "reject"](t)
            }
        }, Ee.alert = Ee, Ee.confirm = function (t) {
            return Ee(n({showCancelButton: !0}, t))
        }, Ee.close = function () {
            Ie && (Ie.value = !1)
            ...
            l.a.use(Le)
        }, Ee.Component = Le, l.a.prototype.$dialog = Ee;
        var De = Ee, Me = Object(r.a)("address-edit-detail"), Fe = Me[0], Pe = Me[1], Ve = Me[2],
            Re = !I.d && /android/.test(navigator.userAgent.toLowerCase()), _e = Fe({
                props: {
                    value: String,
                    error: Boolean,
                    focused: Boolean,
                    ...
                    onSelect: function (t) {
                        ...
                        var t = this.$createElement;
                        if (this.value && this.focused && Re) return t("div", {
                            class: Pe("finish"),
            ...
            }, We = Object(r.a)("switch"), qe = We[0], Ye = We[1];
        ...
        function Ue(t, e, i, n) {
            ...
            }, h(n)]), [t("div", {class: Ye("node")}, [a && t(Ot, {class: Ye("loading"), attrs: {color: y}})])])
        }

        Ue.props = He;
        var Xe = qe(Ue), Ke = Object(r.a)("switch-cell"), Qe = Ke[0], Ge = Ke[1];

        function Ze(t, e, i, s) {
            return t(se, o()([{
                attrs: {center: !0, size: e.cellSize, title: e.title, border: e.border},
                class: Ge([e.cellSize])
            }, h(s)]), [t(Xe, {props: n({}, e), on: n({}, s.listeners)})])
        }
        ...
        var Je = Qe(Ze), ti = Object(r.a)("address-edit"), ei = ti[0], ii = ti[1], ni = ti[2], si = {
            name: "",
            tel: "",
            country: "",
            province: "",
        ...
        var oi = ei({
            props: {
                ...
                telValidator: {type: Function, default: Nt},
                postalValidator: {
                    type: Function, default: function (t) {
                        return /^\d{6}$/.test(t)
                    }
                ...
                addressInfo: {
                    handler: function (t) {
                        this.data = n({}, si, {}, t), this.setAreaCode(t.areaCode)
                    }, deep: !0, immediate: !0
                }, areaList: function () {
                ...
                onFocus: function (t) {
                    ...
                    (t = t.filter(function (t) {
                        ...
                        return !t.code
                    }) ? Se(ni("areaEmpty")) : (this.showAreaPopup = !1, this.assignAreaValues(), this.$emit("change-area", t))
                    ...
                    this.showPostal && e.push("postalCode"), e.every(function (e) {
                        ...
                        return i && (t.errorInfo[e] = !0, Se(i)), !i
                    ...
                    switch (t) {
                        case"name":
                            return e ? "" : ni("nameEmpty");
                        case"tel":
                            return this.telValidator(e) ? "" : ni("telInvalid");
                        case"areaCode":
                            return e ? "" : ni("areaEmpty");
                        case"addressDetail":
                            return e ? "" : ni("addressEmpty");
                        case"postalCode":
                            return e && !this.postalValidator(e) ? ni("postalEmpty") : ""
                    }
                }, onDelete: function () {
                    var t = this;
                    De.confirm({title: ni("confirmDelete")}).then(function () {
                ...
                return e("div", {class: ii()}, [e(ce, {
                    attrs: {
                        clearable: !0,
                        label: ni("name"),
                        placeholder: ni("namePlaceholder"),
                        error: n.name
                    ...
                    attrs: {readonly: !0, label: ni("area"), placeholder: ni("areaPlaceholder"), value: this.areaText},
                    on: {
                        click: function () {
                            t.showAreaPopup = !0
                        }
                ...
                }), this.slots(), this.showSetDefault && e(Je, {
                    directives: [{name: "show", value: !r}],
                    attrs: {title: ni("defaultAddress")},
                    on: {
                        change: function (e) {
                ...
                }), e("div", {directives: [{name: "show", value: !r}], class: ii("buttons")}, [e(Te, {
                    attrs: {
                        block: !0,
                        loading: this.isSaving,
                        type: "danger",
                        text: this.saveButtonText || ni("save")
                    }, on: {click: this.onSave}
                }), this.showDelete && e(Te, {
                    attrs: {
                        block: !0,
                        loading: this.isDeleting,
                        text: this.deleteButtonText || ni("delete")
        ...
        var li = Object(r.a)("radio-group"), ui = li[0], ci = li[1], hi = ui({
            mixins: [ai("vanRadio")],
            ...
            render: function () {
                var t = arguments[0];
                return t("div", {class: ci(), attrs: {role: "radiogroup"}}, [this.slots()])
            }
        }), di = function (t) {
            ...
            return {
                ...
                render: function () {
                    var t = arguments[0], e = this.slots, s = this.checked,
                        o = e("icon", {checked: s}) || t(pt, {attrs: {name: "success"}, style: this.iconStyle}),
                        r = e() && t("span", {
                            ref: "label",
        ...
        }, fi = Object(r.a)("radio"), pi = (0, fi[0])({
            mixins: [di({bem: fi[1], role: "radio", parent: "vanRadio"})],
            computed: {
                currentValue: {
                    get: function () {
        ...
        }), mi = Object(r.a)("address-item"), vi = mi[0], gi = mi[1];

        function bi(t, e, i, n) {
            var s = e.disabled, r = e.switchable;
            return t(se, o()([{
                class: gi({disabled: s}),
                attrs: {valueClass: gi("value"), clickable: r && !s},
                scopedSlots: {
                    default: function () {
                        var i = e.data,
                            n = [t("div", {class: gi("name")}, [i.name + "，" + i.tel]), t("div", {class: gi("address")}, [i.address])];
                        return r && !s ? t(pi, {attrs: {name: i.id, iconSize: 16}}, [n]) : n
                    }, "right-icon": function () {
                        return t(pt, {
                            attrs: {name: "edit"}, class: gi("edit"), on: {
                                click: function (t) {
        ...
        bi.props = {data: Object, disabled: Boolean, switchable: Boolean};
        var yi = vi(bi), ki = Object(r.a)("address-list"), Si = ki[0], xi = ki[1], wi = ki[2];
        ...
        function Ci(t, e, i, n) {
            ...
            return t("div", o()([{class: xi()}, h(n)]), [i.top && i.top(), t(hi, {attrs: {value: e.value}}, [r]), e.disabledText && t("div", {class: xi("disabled-text")}, [e.disabledText]), a, i.default && i.default(), t(Te, {
                attrs: {
                    square: !0,
                    size: "large",
                    type: "danger",
                    text: e.addButtonText || wi("add")
                }, class: xi("add"), on: {
                    click: function () {
                        d(n, "add")
                    }
        ...
        var Oi = Si(Ci), Ti = Object(r.a)("tag"), $i = Ti[0], Ii = Ti[1];
        ...
        function Bi(t, e, i, n) {
            ...
            var g = t("span", o()([{
                style: m,
                class: [Ii([v, a]), (r = {}, r[x] = u, r)]
            }, h(n, !0)]), [i.default && i.default(), e.closeable && t(pt, {
                attrs: {name: "cross"},
                class: Ii("close"),
                on: {
                    click: function () {
        ...
        var ji = $i(Bi), Ni = Object(r.a)("card"), Ai = Ni[0], zi = Ni[1];
        ...
        function Li(t, e, i, n) {
            ...
            function f() {
                if (i.tag || e.tag) return t("div", {class: zi("tag")}, [i.tag ? i.tag() : t(ji, {
                    attrs: {
                        mark: !0,
                        type: "danger"
                    }
            ...
            return t("div", o()([{class: zi()}, h(n, !0)]), [t("div", {class: zi("header")}, [function () {
                if (i.thumb || s) return t("a", {
                    attrs: {href: e.thumbLink},
                    class: zi("thumb"),
                    on: {click: c}
                }, [i.thumb ? i.thumb() : t(ut, {
                    attrs: {
                        src: s,
                        width: "100%",
                        height: "100%",
            ...
            }(), t("div", {class: zi("content", {centered: e.centered})}, [i.title ? i.title() : e.title ? t("div", {class: [zi("title"), "van-multi-ellipsis--l2"]}, [e.title]) : void 0, i.desc ? i.desc() : e.desc ? t("div", {class: [zi("desc"), "van-ellipsis"]}, [e.desc]) : void 0, i.tags && i.tags(), u && t("div", {class: "van-card__bottom"}, [function () {
                if (a) return t("div", {class: zi("price")}, [i.price ? i.price() : e.currency + " " + e.price])
            }(), function () {
                if (l) {
                    var n = i["origin-price"];
                    return t("div", {class: zi("origin-price")}, [n ? n() : e.currency + " " + e.originPrice])
                }
            }(), function () {
                if (r) return t("div", {class: zi("num")}, [i.num ? i.num() : "x " + e.num])
            }(), i.bottom && i.bottom()])])]), function () {
                if (i.footer) return t("div", {class: zi("footer")}, [i.footer()])
            }()])
        }
        ...
        var Ei = Ai(Li), Di = Object(r.a)("cell-group"), Mi = Di[0], Fi = Di[1];

        function Pi(t, e, i, n) {
            var s,
                r = t("div", o()([{class: [Fi(), (s = {}, s[w] = e.border, s)]}, h(n, !0)]), [i.default && i.default()]);
            return e.title || i.title ? t("div", [t("div", {class: Fi("title")}, [i.title ? i.title() : e.title]), r]) : r
        }

        Pi.props = {title: String, border: {type: Boolean, default: !0}};
        var Vi = Mi(Pi), Ri = Object(r.a)("checkbox"), _i = (0, Ri[0])({
            mixins: [di({bem: Ri[1], role: "checkbox", parent: "vanCheckbox"})],
            computed: {
                checked: {
                    get: function () {
        ...
        }), Hi = Object(r.a)("checkbox-group"), Wi = Hi[0], qi = Hi[1], Yi = Wi({
            mixins: [ai("vanCheckbox")],
            props: {
                max: Number,
                disabled: Boolean,
                iconSize: [Number, String],
            ...
            render: function () {
                var t = arguments[0];
                return t("div", {class: qi()}, [this.slots()])
            }
        }), Ui = i(4), Xi = Object(r.a)("circle"), Ki = Xi[0], Qi = Xi[1], Gi = 0;
        ...
        var Ji = Ki({
            props: {
                ...
                this.uid = "van-circle-gradient-" + Gi++
            }, computed: {
                style: function () {
                    var t = Object(tt.a)(this.size);
                ...
                rate: {
                    handler: function () {
                        this.startTime = Date.now(), this.startRate = this.value, this.endRate = Zi(this.rate), this.increase = this.endRate > this.startRate, this.duration = Math.abs(1e3 * (this.startRate - this.endRate) / this.speed), this.speed ? (Object(Ui.a)(this.rafId), this.rafId = Object(Ui.c)(this.animate)) : this.$emit("input", this.endRate)
                    }, immediate: !0
                }
            }, methods: {
                animate: function () {
                    ...
                    this.$emit("input", Zi(parseFloat(e.toFixed(1)))), (this.increase ? e < this.endRate : e > this.endRate) && (this.rafId = Object(Ui.c)(this.animate))
                }
            }, render: function () {
                var t = arguments[0];
                return t("div", {
                ...
                })]), this.slots() || this.text && t("div", {class: Qi("text")}, [this.text])])
            }
        }), tn = Object(r.a)("col"), en = tn[0], nn = tn[1], sn = en({
            ...
            render: function () {
                ...
                return e(this.tag, {
                    style: this.style,
                    class: nn((t = {}, t[i] = i, t["offset-" + n] = n, t)),
                    on: {click: this.onClick}
                }, [this.slots()])
            }
        }), on = Object(r.a)("collapse"), rn = on[0], an = on[1], ln = rn({
            ...
            render: function () {
                var t, e = arguments[0];
                return e("div", {class: [an(), (t = {}, t[w] = this.border, t)]}, [this.slots()])
            }
        }), un = Object(r.a)("collapse-item"), cn = un[0], hn = un[1], dn = ["title", "icon", "right-icon"], fn = cn({
            mixins: [ri("vanCollapse")],
            props: n({}, Qt, {name: [Number, String], disabled: Boolean, isLink: {type: Boolean, default: !0}}),
            data: function () {
            ...
            watch: {
                expanded: function (t, e) {
                    var i = this;
                    null !== e && (t && (this.show = !0, this.inited = !0), (t ? this.$nextTick : Ui.c)(function () {
                        var e = i.$refs, n = e.content, s = e.wrapper;
                        if (n && s) {
                            var o = n.offsetHeight;
                            if (o) {
                                var r = o + "px";
                                s.style.height = t ? 0 : r, Object(Ui.b)(function () {
            ...
            render: function () {
                var t, e = this, i = arguments[0], s = this.disabled, o = this.expanded, r = dn.reduce(function (t, i) {
                ...
                var a = i(se, {
                    ...
                    class: hn("title", {disabled: s, expanded: o}),
                    on: {click: this.onClick},
                    scopedSlots: r,
                    props: n({}, this.$props)
                }), l = this.inited && i("div", {
                    ...
                    class: hn("wrapper"),
                    on: {transitionend: this.onTransitionEnd}
                }, [i("div", {ref: "content", class: hn("content")}, [this.slots()])]);
                return i("div", {class: [hn(), (t = {}, t[y] = this.index, t)]}, [a, l])
            }
        }), pn = Object(r.a)("contact-card"), mn = pn[0], vn = pn[1], gn = pn[2];
        ...
        function bn(t, e, i, n) {
            ...
            }, h(n)]), ["add" === s ? e.addText || gn("addText") : [t("div", [gn("name") + "：" + e.name]), t("div", [gn("tel") + "：" + e.tel])]])
        }
        ...
        var yn = mn(bn), kn = Object(r.a)("contact-edit"), Sn = kn[0], xn = kn[1], wn = kn[2], Cn = {tel: "", name: ""},
            On = Sn({
                props: {
                    isEdit: Boolean,
                    isSaving: Boolean,
                    ...
                    return {data: n({}, Cn, {}, this.contactInfo), errorInfo: {name: !1, tel: !1}}
                }, watch: {
                    ...
                    onFocus: function (t) {
                        ...
                        var t = this;
                        De.confirm({message: wn("confirmDelete")}).then(function () {
                            t.$emit("delete", t.data)
                        })
                    }
                }, render: function () {
                    ...
                    return e("div", {class: xn()}, [e(ce, {
                        ...
                        attrs: {block: !0, text: wn("delete"), loading: this.isDeleting},
                        on: {click: this.onDelete}
                    })])])
                }
            }), Tn = Object(r.a)("contact-list"), $n = Tn[0], In = Tn[1], Bn = Tn[2];
        ...
        function jn(t, e, i, n) {
            var s = e.list && e.list.map(function (e, i) {
                ...
                return t(se, {
                    key: e.id,
                    attrs: {isLink: !0, valueClass: In("item-value")},
                    class: In("item"),
                    scopedSlots: {
                        default: function () {
                            return t(pi, {
                                ...
                                on: {click: s}
                            }, [t("div", {class: In("name")}, [e.name + "，" + e.tel])])
                        }, "right-icon": function () {
                            return t(pt, {
                                attrs: {name: "edit"}, class: In("edit"), on: {
                                    click: function (t) {
            ...
            return t("div", o()([{class: In()}, h(n)]), [t(hi, {
                attrs: {value: e.value},
                class: In("group")
            }, [s]), t(Te, {
                attrs: {square: !0, size: "large", type: "danger", text: e.addText || Bn("addText")},
                class: In("add"),
                on: {
                    click: function () {
                        d(n, "add")
        ...
        jn.props = {value: null, list: Array, addText: String};
        var Nn = $n(jn), An = i(3), zn = 1e3, Ln = 60 * zn, En = 60 * Ln, Dn = 24 * En;
        var Mn = Object(r.a)("count-down"), Fn = Mn[0], Pn = Mn[1], Vn = Fn({
            props: {
                millisecond: Boolean,
                ...
                timeData: function () {
                    return t = this.remain, {
                        days: Math.floor(t / Dn),
                        hours: Math.floor(t % Dn / En),
                        minutes: Math.floor(t % En / Ln),
                        seconds: Math.floor(t % Ln / zn),
                        milliseconds: Math.floor(t % zn)
                    };
                    var t
                }, formattedTime: function () {
                    return t = this.format, e = this.timeData, i = e.days, n = e.hours, s = e.minutes, o = e.seconds, r = e.milliseconds, -1 === t.indexOf("DD") ? n += 24 * i : t = t.replace("DD", Object(An.b)(i)), -1 === t.indexOf("HH") ? s += 60 * n : t = t.replace("HH", Object(An.b)(n)), -1 === t.indexOf("mm") ? o += 60 * s : t = t.replace("mm", Object(An.b)(s)), -1 === t.indexOf("ss") ? r += 1e3 * o : t = t.replace("ss", Object(An.b)(o)), t.replace("SSS", Object(An.b)(r, 3));
                    var t, e, i, n, s, o, r
                }
                ...
                start: function () {
                    ...
                    this.counting = !1, Object(Ui.a)(this.rafId)
                }, reset: function () {
                    ...
                    var t = this;
                    this.rafId = Object(Ui.c)(function () {
                ...
                var t = arguments[0];
                return t("div", {class: Pn()}, [this.slots("default", this.timeData) || this.formattedTime])
            }
        }), Rn = Object(r.a)("coupon"), _n = Rn[0], Hn = Rn[1], Wn = Rn[2];

        function qn(t) {
            var e = new Date(1e3 * t);
            return e.getFullYear() + "." + Object(An.b)(e.getMonth() + 1) + "." + Object(An.b)(e.getDate())
        }
        ...
        var Un = _n({
            ...
            computed: {
                validPeriod: function () {
                    ...
                    return Wn("valid") + "：" + qn(e) + " - " + qn(i)
                }, faceAmount: function () {
                    var t, e = this.coupon;
                    return e.valueDesc ? e.valueDesc + "<span>" + (e.unitDesc || "") + "</span>" : e.denominations ? "<span>" + this.currency + "</span> " + Yn(this.coupon.denominations) : e.discount ? Wn("discount", ((t = this.coupon.discount) / 10).toFixed(t % 10 == 0 ? 0 : 1)) : ""
                }, conditionMessage: function () {
                    var t = Yn(this.coupon.originCondition);
                    return "0" === t ? Wn("unlimited") : Wn("condition", t)
                }
            },
            render: function () {
                var t = arguments[0], e = this.coupon, i = this.disabled, n = i && e.reason || e.description;
                return t("div", {class: Hn({disabled: i})}, [t("div", {class: Hn("content")}, [t("div", {class: Hn("head")}, [t("h2", {
                    class: Hn("amount"),
                    domProps: {innerHTML: this.faceAmount}
                }), t("p", [this.coupon.condition || this.conditionMessage])]), t("div", {class: Hn("body")}, [t("h2", {class: Hn("name")}, [e.name]), t("p", [this.validPeriod]), this.chosen && t(_i, {
                    attrs: {
                        value: !0,
                        "checked-color": p
                    }, class: Hn("corner")
                })])]), n && t("p", {class: Hn("description")}, [n])])
            }
        }), Xn = Object(r.a)("coupon-cell"), Kn = Xn[0], Qn = Xn[1], Gn = Xn[2];

        function Zn(t, e, i, n) {
            var s = e.coupons[e.chosenCoupon] ? "van-coupon-cell--selected" : "", r = function (t) {
                var e = t.coupons, i = t.chosenCoupon, n = t.currency, s = e[i];
                return s ? "-" + n + ((s.denominations || s.value) / 100).toFixed(2) : 0 === e.length ? Gn("tips") : Gn("count", e.length)
            }(e);
            return t(se, o()([{
                class: Qn(),
                attrs: {value: r, title: e.title || Gn("title"), border: e.border, isLink: e.editable, valueClass: s}
            }, h(n, !0)]))
        }

        Zn.model = {prop: "chosenCoupon"}, Zn.props = {
            title: String,
            coupons: {
                type: Array, default: function () {
                    return []
        ...
        var Jn = Kn(Zn), ts = Object(r.a)("tab"), es = ts[0], is = ts[1], ns = es({
            mixins: [ri("vanTabs")],
            props: n({}, Jt, {name: [Number, String], title: String, disabled: Boolean}),
            data: function () {
                return {inited: !1}
            },
            computed: {
            ...
            render: function (t) {
                ...
                return e("title") && n.push(t("div", {ref: "title"}, [e("title")])), this.parent.animated ? t("div", {
                    attrs: {
                        role: "tabpanel",
                        "aria-hidden": !i
                    }, class: is("pane-wrapper", {inactive: !i})
                }, [t("div", {class: is("pane")}, [n])]) : t("div", {
        ...
        var os = Object(r.a)("tab")[1], rs = {
            props: {
                ...
                return t("div", {
                    ...
                    class: os({active: this.isActive, disabled: this.disabled, complete: !this.ellipsis}),
                    style: this.style,
                    on: {click: this.onClick}
                }, [t("span", {ref: "title", class: {"van-ellipsis": this.ellipsis}}, [this.title])])
            }
        }, as = Object(r.a)("tabs"), ls = as[0], us = as[1], cs = ls({
            mixins: [T],
            ...
            render: function () {
                var t = arguments[0];
                return t("div", {
                    class: us("content", {animated: this.animated}),
                    on: n({}, this.listeners)
                }, [this.renderChildren()])
            }
        }), hs = Object(r.a)("sticky"), ds = hs[0], fs = hs[1], ps = ds({
            mixins: [$e(function (t) {
                this.scroller || (this.scroller = U(this.$el)), t(this.scroller, "scroll", this.onScroll, !0), this.onScroll()
                ...
                onScroll: function () {
                    ...
                    var e = this.container, i = this.offsetTop, n = X(window), s = Z(this.$el), o = function () {
                ...
                return t("div", {style: i}, [t("div", {class: fs({fixed: e}), style: this.style}, [this.slots()])])
            }
        }), ms = Object(r.a)("tabs"), vs = ms[0], gs = ms[1], bs = vs({
            mixins: [ai("vanTabs"), $e(function (t) {
            ...
            watch: {
                color: "setLine", active: function (t) {
                    ...
                    this.scrollIntoView(), this.setLine(), this.stickyFixed && G(Math.ceil(Z(this.$el) - this.offsetTop))
                }
            },
            mounted: function () {
                this.onShow()
            ...
            methods: {
                onShow: function () {
                    ...
                    this.$nextTick(function () {
                        var i = t.$refs.titles;
                        if (i && i[t.currentIndex] && "line" === t.type && !ss(t.$el)) {
                    ...
                    if (this.scrollable && e && e[this.currentIndex]) {
                        ...
                        !function (t, e, i) {
                            ...
                            !function i() {
                                t.scrollLeft += (e - s) / o, ++n < o && Object(Ui.c)(i)
                            }()
            ...
            render: function () {
                var t, e = this, i = arguments[0], n = this.type, s = this.ellipsis, o = this.animated,
                    r = this.scrollable, a = this.children.map(function (t, o) {
                        return i(rs, {
                            ...
                            on: {
                                click: function () {
                                    e.onClick(o), Gt(t.$router, t)
                                }
                            }
                        })
                    }), l = i("div", {
                        ref: "wrap",
                        class: [gs("wrap", {scrollable: r}), (t = {}, t[w] = "line" === n && this.border, t)]
                    }, [i("div", {
                        ref: "nav",
                        attrs: {role: "tablist"},
                        class: gs("nav", [n]),
                ...
                return i("div", {class: gs([n])}, [this.sticky ? i(ps, {
                    attrs: {
                        container: this.$el,
        ...
        }), ys = Object(r.a)("coupon-list"), ks = ys[0], Ss = ys[1], xs = ys[2], ws = ks({
            model: {prop: "code"},
            props: {
                code: String,
            ...
            methods: {
                onClickExchangeButton: function () {
                    ...
                    var t = this.$createElement;
                    return t("div", {class: Ss("empty")}, [t("img", {attrs: {src: this.emptyImage}}), t("p", [xs("empty")])])
                }, renderExchangeButton: function () {
                    return (0, this.$createElement)(Te, {
                        attrs: {
                            size: "small",
                            type: "danger",
                            text: this.exchangeButtonText || xs("exchange"),
                            loading: this.exchangeButtonLoading,
                            disabled: this.buttonDisabled
                        }, class: Ss("exchange"), on: {click: this.onClickExchangeButton}
                    })
                }
            },
            render: function () {
                var t = this, e = arguments[0], i = this.coupons, n = this.disabledCoupons,
                    s = (this.enabledTitle || xs("enable")) + " (" + i.length + ")",
                    o = (this.disabledTitle || xs("disabled")) + " (" + n.length + ")",
                    r = this.showExchangeBar && e(ce, {
                        attrs: {
                            clearable: !0,
                            border: !1,
                            placeholder: this.inputPlaceholder || xs("placeholder"),
                            maxlength: "20"
                        },
                        class: Ss("field"),
                    ...
                    }), !i.length && this.renderEmpty()])]), u = e(ns, {attrs: {title: o}}, [e("div", {
                        class: Ss("list"),
                        style: this.listStyle
                    }, [n.map(function (i) {
                        return e(Un, {attrs: {disabled: !0, coupon: i, currency: t.currency}, key: i.id})
                    }), !n.length && this.renderEmpty()])]);
                return e("div", {class: Ss()}, [r, e(bs, {
                    class: Ss("tab"),
                    ...
                    attrs: {size: "large", text: this.closeButtonText || xs("close")},
                    class: Ss("close"),
                    on: {click: a(-1)}
                })])
            }
        ...
        var Ts = n({}, Lt, {
            ...
            data: function () {
                ...
                return Object.keys(Lt).forEach(function (e) {
                    i[e] = t[e]
                }), e(qt, {
                    ref: "picker",
            ...
            methods: {
                formatValue: function (t) {
                    t || (t = Object(An.b)(this.minHour) + ":" + Object(An.b)(this.minMinute));
                    var e = t.split(":"), i = e[0], n = e[1];
                    return (i = Object(An.b)(Et(i, this.minHour, this.maxHour))) + ":" + (n = Object(An.b)(Et(n, this.minMinute, this.maxMinute)))
        ...
        function Bs(t) {
            return "[object Date]" === Object.prototype.toString.call(t) && !Object(Cs.a)(t.getTime())
        }

        var js = (new Date).getFullYear(), Ns = (0, Object(r.a)("date-picker")[0])({
            mixins: [$s],
            props: n({}, Ts, {
                type: {type: String, default: "datetime"}, minDate: {
                    type: Date, default: function () {
                        return new Date(js - 10, 0, 1)
                    }, validator: Bs
                }, maxDate: {
                    type: Date, default: function () {
                        return new Date(js + 10, 11, 31)
                    }, validator: Bs
                }
            }),
            watch: {
            ...
            methods: {
                formatValue: function (t) {
                    return Bs(t) || (t = this.minDate), t = Math.max(t, this.minDate.getTime()), t = Math.min(t, this.maxDate.getTime()), new Date(t)
                }, getBoundary: function (t, e) {
                    var i, n = this[t + "Date"], s = n.getFullYear(), o = 1, r = 1, a = 0, l = 0;
                    return "max" === t && (o = 12, r = Os(e.getFullYear(), e.getMonth() + 1), a = 23, l = 59), e.getFullYear() === s && (o = n.getMonth() + 1, e.getMonth() + 1 === o && (r = n.getDate(), e.getDate() === r && (a = n.getHours(), e.getHours() === a && (l = n.getMinutes())))), (i = {})[t + "Year"] = s, i[t + "Month"] = o, i[t + "Date"] = r, i[t + "Hour"] = a, i[t + "Minute"] = l, i
                }, updateInnerValue: function () {
                    var t, e = this, i = this.$refs.picker.getIndexes(), n = function (t) {
                        return function (t) {
                            if (t) {
                                for (; Object(Cs.a)(parseInt(t, 10));) {
                    ...
                    var t = this, e = this.innerValue, i = this.formatter,
                        n = [i("year", "" + e.getFullYear()), i("month", Object(An.b)(e.getMonth() + 1)), i("day", Object(An.b)(e.getDate()))];
                    "datetime" === this.type && n.push(i("hour", Object(An.b)(e.getHours())), i("minute", Object(An.b)(e.getMinutes()))), "year-month" === this.type && (n = n.slice(0, 2)), this.$nextTick(function () {
                        t.$refs.picker.setValues(n)
                    })
                }
            }
        }), As = Object(r.a)("datetime-picker"), zs = As[0], Ls = As[1], Es = zs({
            props: n({}, Is.props, {}, Ns.props), render: function () {
                var t = arguments[0], e = "time" === this.type ? Is : Ns;
                return t(e, {class: Ls(), props: n({}, this.$props), on: n({}, this.$listeners)})
            }
        }), Ds = Object(r.a)("divider"), Ms = Ds[0], Fs = Ds[1];
        ...
        var Vs = Ms(Ps), Rs = Object(r.a)("dropdown-item"), _s = Rs[0], Hs = Rs[1], Ws = _s({
            mixins: [$({ref: "wrapper"}), ri("vanDropdownMenu")],
            props: {
                value: null,
                title: String,
                disabled: Boolean,
            ...
            render: function () {
                var t = this, e = arguments[0], i = this.parent, n = i.zIndex, s = i.offset, o = i.overlay,
                    ...
                    c = this.options.map(function (i) {
                        ...
                        }, [n && e(pt, {class: Hs("icon"), attrs: {color: l, name: "success"}})])
                    }), h = {zIndex: n};
                return "down" === a ? h.top = s + "px" : h.bottom = s + "px", e("div", [e("div", {
                    directives: [{
                        name: "show",
                        value: this.showWrapper
                    }], ref: "wrapper", style: h, class: Hs([a])
                }, [e(bt, {
                    attrs: {
                        overlay: o,
        ...
        }, Ys = Object(r.a)("dropdown-menu"), Us = Ys[0], Xs = Ys[1], Ks = Us({
            mixins: [ai("vanDropdownMenu"), qs({event: "click", method: "onClickOutside"})],
            props: {
                activeColor: String,
                overlay: {type: Boolean, default: !0},
            ...
            render: function () {
                var t = this, e = arguments[0], i = this.children.map(function (i, n) {
                    return e("div", {
                        ...
                        class: Xs("item", {disabled: i.disabled}),
                        on: {
                            click: function () {
                ...
                return e("div", {ref: "menu", class: [Xs(), w]}, [i, this.slots("default")])
            }
        }), Qs = Object(r.a)("goods-action"), Gs = Qs[0], Zs = Qs[1], Js = Gs({
            mixins: [ai("vanGoodsAction")], props: {safeAreaInsetBottom: Boolean}, render: function () {
                var t = arguments[0];
                return t("div", {class: Zs({"safe-area-inset-bottom": this.safeAreaInsetBottom})}, [this.slots()])
            }
        }), to = Object(r.a)("goods-action-button"), eo = to[0], io = to[1], no = eo({
            mixins: [ri("vanGoodsAction")],
            props: n({}, Jt, {type: String, text: String, color: String, loading: Boolean, disabled: Boolean}),
            computed: {
                isFirst: function () {
            ...
            methods: {
                onClick: function (t) {
                    this.$emit("click", t), Gt(this.$router, this)
                }
            },
            render: function () {
                var t = arguments[0];
                return t(Te, {
                    class: io([{first: this.isFirst, last: this.isLast}, this.type]),
                    attrs: {
                        square: !0,
                        size: "large",
                        type: this.type,
        ...
        }), so = Object(r.a)("goods-action-icon"), oo = so[0], ro = so[1], ao = oo({
            mixins: [ri("vanGoodsAction")],
            props: n({}, Jt, {text: String, icon: String, info: [Number, String], iconClass: null}),
            methods: {
                onClick: function (t) {
                    this.$emit("click", t), Gt(this.$router, this)
                }
            ...
            render: function () {
                ...
                return t("div", {
                    ...
                    class: ro(),
                    on: {click: this.onClick}
                }, [this.slots("icon") ? t("div", {class: ro("icon")}, [this.slots("icon")]) : t(pt, {
                    class: [ro("icon"), this.iconClass],
                    attrs: {tag: "div", info: this.info, name: this.icon}
                }), this.slots() || this.text])
            }
        }), lo = Object(r.a)("grid"), uo = lo[0], co = lo[1], ho = uo({
            mixins: [ai("vanGrid")],
            props: {
                square: Boolean,
            ...
            computed: {
                style: function () {
                    var t = this.gutter;
                    if (t) return {paddingLeft: Object(tt.a)(t)}
                }
            },
            render: function () {
                var t, e = arguments[0];
                return e("div", {
                    style: this.style,
                    class: [co(), (t = {}, t[y] = this.border && !this.gutter, t)]
                }, [this.slots()])
            }
        }), fo = Object(r.a)("grid-item"), po = fo[0], mo = fo[1], vo = po({
            mixins: [ri("vanGrid")],
            props: n({}, Jt, {dot: Boolean, text: String, icon: String, info: [Number, String]}),
            computed: {
                style: function () {
            ...
            methods: {
                onClick: function (t) {
                    ...
                    var t = this.$createElement, e = this.slots();
                    return e || [this.slots("icon") || this.icon && t(pt, {
                        attrs: {
                            name: this.icon,
                            dot: this.dot,
                            info: this.info,
                    ...
                    }), this.slots("text") || this.text && t("span", {class: mo("text")}, [this.text])]
                }
            },
            render: function () {
                var t, e = arguments[0], i = this.parent, n = i.center, s = i.border, o = i.square, r = i.gutter,
                    a = i.clickable;
                return e("div", {class: [mo({square: o})], style: this.style}, [e("div", {
        ...
        }), go = Object(r.a)("swipe"), bo = go[0], yo = go[1], ko = bo({
            ...
            methods: {
                initialize: function (t) {
                    ...
                    return t ? this.loop ? Et(e + t, -1, i) : Et(e + t, 0, i - 1) : e
                    ...
                    var i = this;
                    void 0 === e && (e = {}), this.swiping = !0, this.resetTouchStatus(), this.correctPosition(), Object(Ui.b)(function () {
                        var n;
                        n = i.loop && t === i.count ? 0 === i.active ? 0 : t : t % i.count, i.move({
                            pace: n - i.active,
                            emitChange: !0
                        }), e.immediate ? Object(Ui.b)(function () {
                            i.swiping = !1
                        }) : i.swiping = !1
                    })
                    ...
                    e && this.count > 1 && (this.clear(), this.timer = setTimeout(function () {
                        t.swiping = !0, t.resetTouchStatus(), t.correctPosition(), Object(Ui.b)(function () {
                    ...
                    return s || (this.showIndicators && i > 1 ? e("div", {class: yo("indicators", {vertical: this.vertical})}, [Array.apply(void 0, Array(i)).map(function (i, s) {
                        return e("i", {
                            class: yo("indicator", {active: s === n}),
        ...
        }), So = Object(r.a)("swipe-item"), xo = So[0], wo = So[1], Co = xo({
            data: function () {
                return {offset: 0}
            }, beforeCreate: function () {
                ...
                return t("div", {class: wo(), style: r, on: n({}, this.$listeners)}, [this.slots()])
            }
        }), Oo = Object(r.a)("image-preview"), To = Oo[0], $o = Oo[1];
        ...
        var Bo, jo = To({
            ...
            props: {
                ...
                overlayClass: {type: String, default: $o("overlay")}
            },
            data: function () {
            ...
            methods: {
                onWrapperTouchStart: function () {
                    ...
                    this.moving = !1, this.zooming = !0, this.startScale = this.scale, this.startDistance = Io(t.touches)
                    ...
                    if (this.zooming && 2 === e.length) {
                        var s = Io(e), o = this.startScale * s / this.startDistance;
                        this.scale = Et(o, this.minZoom, this.maxZoom)
                    }
                    ...
                    var t = this.$createElement;
                    if (this.showIndex) return t("div", {class: $o("index")}, [this.slots("index") || this.active + 1 + " / " + this.images.length])
                }, genCover: function () {
                    var t = this.$createElement, e = this.slots("cover");
                    if (e) return t("div", {class: $o("cover")}, [e])
                }, genImages: function () {
                    var t = this, e = this.$createElement, i = {
                        loading: function () {
                            return e(Ot, {attrs: {type: "spinner"}})
                        }
                    };
                    return e(ko, {
                        ref: "swipe",
            ...
            render: function () {
                var t = arguments[0];
                if (this.value) return t("transition", {attrs: {name: "van-fade"}}, [t("div", {class: [$o(), this.className]}, [this.genImages(), this.genIndex(), this.genCover()])])
            }
        }), No = {
            images: [],
            loop: !0,
            ...
            if (void 0 === e && (e = 0), !I.d) {
                Bo || (Bo = new (l.a.extend(jo))({el: document.createElement("div")}), document.body.appendChild(Bo.$el), Bo.$on("change", function (t) {
                    Bo.onChange && Bo.onChange(t)
                }));
                var i = Array.isArray(t) ? {images: t, startPosition: e} : t;
                return n(Bo, No, i), Bo.$once("input", function (t) {
                    Bo.value = t
                }), i.onClose && Bo.$once("close", i.onClose), Bo
            }
        };
        Ao.install = function () {
            l.a.use(jo)
        };
        var zo = Ao, Lo = Object(r.a)("index-anchor"), Eo = Lo[0], Do = Lo[1], Mo = Eo({
            ...
            render: function () {
                ...
                return e("div", {style: {height: i ? this.height + "px" : null}}, [e("div", {
                    ...
                    class: [Do({sticky: i}), (t = {}, t[S] = i, t)]
                }, [this.slots("default") || this.index])])
            }
        }), Fo = Object(r.a)("index-bar"), Po = Fo[0], Vo = Fo[1], Ro = Po({
            mixins: [T, ai("vanIndexBar"), $e(function (t) {
                this.scroller || (this.scroller = U(this.$el)), t(this.scroller, "scroll", this.onScroll)
            })],
            props: {
            ...
            methods: {
                onScroll: function () {
                    var t = this, e = X(this.scroller), i = this.getScrollerRect(), n = this.children.map(function (e) {
                    ...
                    var i = this.scroller;
                    return i === window || i === document.body ? Z(t) : t.getBoundingClientRect().top - e.top + X(i)
                    ...
                    if (e) {
                        ...
                        i[0] && (i[0].scrollIntoView(), this.stickyOffsetTop && G(Q() - this.stickyOffsetTop), this.$emit("select", i[0].index))
                    }
                }, onTouchEnd: function () {
                    this.active = null
                }
        ...
        }), _o = i(10), Ho = i.n(_o).a, Wo = Object(r.a)("list"), qo = Wo[0], Yo = Wo[1], Uo = Wo[2], Xo = qo({
            mixins: [$e(function (t) {
                this.scroller || (this.scroller = U(this.$el)), t(this.scroller, "scroll", this.check)
            })],
            model: {prop: "loading"},
            props: {
                error: Boolean,
            ...
            render: function () {
                var t = arguments[0], e = t("div", {ref: "placeholder", class: Yo("placeholder")});
                return t("div", {
                    class: Yo(),
                    ...
                    class: Yo("loading"),
                    key: "loading"
                }, [this.slots("loading") || t(Ot, {attrs: {size: "16"}}, [this.loadingText || Uo("loading")])]), this.finished && this.finishedText && t("div", {class: Yo("finished-text")}, [this.finishedText]), this.error && this.errorText && t("div", {
                    on: {click: this.clickErrorText},
                    class: Yo("error-text")
                }, [this.errorText]), "up" === this.direction ? this.slots() : e])
            }
        }), Ko = i(5), Qo = Object(r.a)("nav-bar"), Go = Qo[0], Zo = Qo[1];

        function Jo(t, e, i, n) {
            var s;
            return t("div", o()([{
                class: [Zo({fixed: e.fixed}), (s = {}, s[S] = e.border, s)],
                style: {zIndex: e.zIndex}
            }, h(n)]), [t("div", {
                class: Zo("left"),
                on: {click: n.listeners["click-left"] || I.e}
            }, [i.left ? i.left() : [e.leftArrow && t(pt, {
                class: Zo("arrow"),
                attrs: {name: "arrow-left"}
            }), e.leftText && t("span", {class: Zo("text")}, [e.leftText])]]), t("div", {class: [Zo("title"), "van-ellipsis"]}, [i.title ? i.title() : e.title]), t("div", {
                class: Zo("right"),
                on: {click: n.listeners["click-right"] || I.e}
            }, [i.right ? i.right() : e.rightText && t("span", {class: Zo("text")}, [e.rightText])])])
        }
        ...
        var tr = Go(Jo), er = Object(r.a)("notice-bar"), ir = er[0], nr = er[1], sr = ir({
            props: {
                text: String,
                mode: String,
                color: String,
                    ...
                    handler: function () {
                        ...
                        this.$nextTick(function () {
                            ...
                            if (i && n) {
                                ...
                                t.scrollable && o > s && (t.wrapWidth = s, t.offsetWidth = o, t.duration = o / t.speed, t.animationClass = nr("play"))
                            }
                        })
                    }, immediate: !0
                }
                ...
                onClickIcon: function (t) {
                    ...
                    this.firstRound = !1, this.$nextTick(function () {
                        t.duration = (t.offsetWidth + t.wrapWidth) / t.speed, t.animationClass = nr("play--infinite")
                    })
                }
            }, render: function () {
                ...
                function l() {
                    var t = i("left-icon");
                    return t || (s ? e(pt, {class: nr("left-icon"), attrs: {name: s}}) : void 0)
                }
                ...
                function u() {
                    ...
                    return s ? e(pt, {class: nr("right-icon"), attrs: {name: s}, on: {click: o}}) : void 0
                }

                return e("div", {
                    attrs: {role: "alert"},
                    directives: [{name: "show", value: this.showNoticeBar}],
                    class: nr({wrapable: this.wrapable}),
                    style: r,
                    on: {
                        click: function (e) {
                            t.$emit("click", e)
                ...
                }, [l(), e("div", {ref: "wrap", class: nr("wrap"), attrs: {role: "marquee"}}, [e("div", {
                    ref: "content",
                    class: [nr("content"), this.animationClass, {"van-ellipsis": !this.scrollable && !this.wrapable}],
                    style: a,
                    on: {animationend: this.onAnimationEnd, webkitAnimationEnd: this.onAnimationEnd}
                }, [this.slots() || this.text])]), u()])
            }
        }), or = Object(r.a)("notify"), rr = or[0], ar = or[1];
        ...
        function dr(t) {
            var e;
            if (!I.d) return cr || (cr = f(hr, {
                on: {
                    click: function (t) {
                        cr.onClick && cr.onClick(t)
                    }, close: function () {
                        cr.onClose && cr.onClose()
                    }, opened: function () {
                        cr.onOpened && cr.onOpened()
                    }
                }
            })), t = n({}, dr.currentOptions, {}, (e = t, Object(I.c)(e) ? e : {message: e})), n(cr, t), clearTimeout(ur), t.duration && t.duration > 0 && (ur = setTimeout(dr.clear, t.duration)), cr
        }
        ...
        dr.clear = function () {
            cr && (cr.value = !1)
        }, dr.currentOptions = fr(), dr.setDefaultOptions = function (t) {
            n(dr.currentOptions, t)
        }, dr.resetDefaultOptions = function () {
            dr.currentOptions = fr()
        }, dr.install = function () {
            l.a.use(hr)
        }, l.a.prototype.$notify = dr;
        var pr = dr, mr = Object(r.a)("key"), vr = mr[0], gr = mr[1], br = vr({
                mixins: [T],
                props: {
                ...
                computed: {
                    className: function () {
                        ...
                        return this.active && t.push("active"), this.type && t.push(this.type), gr(t)
                    }
                },
                methods: {
                    onTouchStart: function (t) {
            ...
            }), yr = Object(r.a)("number-keyboard"), kr = yr[0], Sr = yr[1], xr = yr[2], wr = ["blue", "big"],
            Cr = ["delete", "big", "gray"], Or = kr({
                mixins: [$e(function (t) {
                ...
                computed: {
                    keys: function () {
                        ...
                        return this.deleteButtonText || xr("delete")
                    }
                },
                methods: {
                    onBlur: function () {
                ...
                render: function () {
                    var t = this, e = arguments[0], i = this.title, n = this.theme, s = this.onPress,
                        ...
                        u = l && e("div", {class: [Sr("title"), y]}, [r && e("span", {class: Sr("title-left")}, [r]), i && e("span", [i]), a && e("span", {
                            attrs: {
                                role: "button",
                                tabindex: "0"
                            }, class: Sr("close"), on: {click: this.onClose}
                        ...
                        }), h = "custom" === n && e("div", {class: Sr("sidebar")}, [e(br, {
                            attrs: {
                                text: this.deleteText,
                                type: "delete",
                                theme: Cr
                            }, on: {press: s}
                        }, [this.slots("delete")]), e(br, {attrs: {text: o, type: "close", theme: wr}, on: {press: s}})]);
                    return e("transition", {attrs: {name: this.transition ? "van-slide-up" : ""}}, [e("div", {
                        ...
                        class: Sr([n, {"safe-area-inset-bottom": this.safeAreaInsetBottom}]),
                        on: {touchstart: z, animationend: this.onAnimationEnd, webkitAnimationEnd: this.onAnimationEnd}
                    }, [u, e("div", {class: Sr("body")}, [c, h])])])
                }
            }), Tr = Object(r.a)("pagination"), $r = Tr[0], Ir = Tr[1], Br = Tr[2];
        ...
        var Nr = $r({
            props: {
                ...
                return e("ul", {class: Ir({simple: n})}, [e("li", {
                    class: [Ir("item", {disabled: 1 === i}), Ir("prev"), b],
                    on: {click: s(i - 1)}
                }, [this.prevText || Br("prev")]), this.pages.map(function (t) {
                    return e("li", {
                        class: [Ir("item", {active: t.active}), Ir("page"), b],
                        on: {click: s(t.number)}
                    }, [t.text])
                }), n && e("li", {class: Ir("page-desc")}, [this.slots("pageDesc") || i + "/" + this.count]), e("li", {
                    class: [Ir("item", {disabled: i === this.count}), Ir("next"), b],
                    on: {click: s(i + 1)}
                }, [this.nextText || Br("next")])])
            }
        }), Ar = Object(r.a)("panel"), zr = Ar[0], Lr = Ar[1];

        function Er(t, e, i, n) {
            return t(Vi, o()([{
                class: Lr(), scopedSlots: {
                    default: function () {
                        return [i.header ? i.header() : t(se, {
                            attrs: {
                                icon: e.icon,
                                label: e.desc,
                                title: e.title,
                                value: e.status,
                                valueClass: Lr("header-value")
                            }, class: Lr("header")
                        }), t("div", {class: Lr("content")}, [i.default && i.default()]), i.footer && t("div", {class: [Lr("footer"), y]}, [i.footer()])]
                    }
                }
            }, h(n, !0)]))
        }

        Er.props = {icon: String, desc: String, title: String, status: String};
        var Dr = zr(Er), Mr = Object(r.a)("password-input"), Fr = Mr[0], Pr = Mr[1];

        function Vr(t, e, i, n) {
            for (var s, r = e.errorInfo || e.info, a = [], l = 0; l < e.length; l++) {
                var u, c = e.value[l], f = 0 !== l && !e.gutter, p = e.focused && l === e.value.length, m = void 0;
                0 !== l && e.gutter && (m = {marginLeft: Object(tt.a)(e.gutter)}), a.push(t("li", {
                    class: (u = {}, u[k] = f, u),
                    style: m
                }, [e.mask ? t("i", {style: {visibility: c ? "visible" : "hidden"}}) : c, p && t("div", {class: Pr("cursor")})]))
            }
            return t("div", {class: Pr()}, [t("ul", o()([{
                class: [Pr("security"), (s = {}, s[x] = !e.gutter, s)],
                on: {
                    touchstart: function (t) {
                        t.stopPropagation(), d(n, "focus", t)
                    }
                }
            }, h(n, !0)]), [a]), r && t("div", {class: Pr(e.errorInfo ? "error-info" : "info")}, [r])])
        }
        ...
        var Rr = Fr(Vr), _r = Object(r.a)("progress"), Hr = _r[0], Wr = _r[1], qr = Hr({
                props: {
                    color: String,
                    inactive: Boolean,
                    pivotText: String,
                    ...
                    var t = arguments[0], e = this.pivotText, i = this.percentage, n = Object(I.b)(e) ? e : i + "%",
                        ...
                        l = {background: this.trackColor, height: Object(tt.a)(this.strokeWidth)};
                    return t("div", {class: Wr(), style: l}, [t("span", {
                        class: Wr("portion"),
                        style: a
                    }, [s && t("span", {ref: "pivot", style: r, class: Wr("pivot")}, [n])])])
                }
            }), Yr = Object(r.a)("pull-refresh"), Ur = Yr[0], Xr = Yr[1], Kr = Yr[2],
            Qr = ["pulling", "loosing", "success"], Gr = Ur({
                mixins: [T],
                props: {
                    disabled: Boolean,
                    successText: String,
                ...
                methods: {
                    onTouchStart: function (t) {
                        ...
                        return this.ceiling = 0 === X(this.scrollEl), this.ceiling
                    }, ease: function (t) {
                ...
                render: function () {
                    var t = arguments[0], e = this.status, i = this.distance, n = this[e + "Text"] || Kr(e), s = {
                            transitionDuration: this.duration + "ms",
                            transform: this.distance ? "translate3d(0," + this.distance + "px, 0)" : ""
                        },
                        o = this.slots(e, {distance: i}) || [-1 !== Qr.indexOf(e) && t("div", {class: Xr("text")}, [n]), "loading" === e && t(Ot, {attrs: {size: "16"}}, [n])];
                    return t("div", {class: Xr()}, [t("div", {
                        class: Xr("track"),
                        style: s,
                        on: {
                            touchstart: this.onTouchStart,
                    ...
                    }, [t("div", {class: Xr("head")}, [o]), this.slots()])])
                }
            }), Zr = Object(r.a)("rate"), Jr = Zr[0], ta = Zr[1];
        var ea = Jr({
            mixins: [T],
            props: {
                size: [Number, String],
            ...
            computed: {
                list: function () {
                    ...
                    return Object(tt.a)(this.size)
                }, gutterWithUnit: function () {
                    return Object(tt.a)(this.gutter)
                }
            },
            methods: {
                select: function (t) {
        ...
        }), ia = Object(r.a)("row"), na = ia[0], sa = ia[1], oa = na({
            props: {
                type: String,
                align: String,
                justify: String,
                ...
                return e(this.tag, {
                    style: r,
                    class: sa((t = {flex: s}, t["align-" + i] = s && i, t["justify-" + n] = s && n, t)),
                    on: {click: this.onClick}
                }, [this.slots()])
            }
        }), ra = Object(r.a)("search"), aa = ra[0], la = ra[1], ua = ra[2];
        ...
        function ca(t, e, i, s) {
            ...
            return delete a.attrs, t("div", o()([{
                class: la({"show-action": e.showAction}),
                style: {background: e.background}
            }, a]), [t("div", {class: la("content", e.shape)}, [function () {
                if (i.label || e.label) return t("div", {class: la("label")}, [i.label ? i.label() : e.label])
            }(), t(ce, o()([{
                attrs: {
                    type: "search",
                    border: !1,
                ...
                }, [i.action ? i.action() : e.actionText || ua("cancel")])
            }()])
        }
        ...
        var ha = aa(ca), da = Object(r.a)("sidebar"), fa = da[0], pa = da[1], ma = fa({
            mixins: [ai("vanSidebar")],
            model: {prop: "activeKey"},
            props: {activeKey: {type: [Number, String], default: 0}},
            render: function () {
                var t = arguments[0];
                return t("div", {class: pa()}, [this.slots()])
            }
        }), va = Object(r.a)("sidebar-item"), ga = va[0], ba = va[1], ya = ga({
            mixins: [ri("vanSidebar")],
            props: n({}, Jt, {dot: Boolean, info: [Number, String], title: String, disabled: Boolean}),
            computed: {
                select: function () {
            ...
            methods: {
                onClick: function () {
                    this.disabled || (this.$emit("click", this.index), this.parent.$emit("input", this.index), this.parent.$emit("change", this.index), Gt(this.$router, this))
                }
            },
            render: function () {
                var t = arguments[0];
                return t("a", {
                    class: ba({select: this.select, disabled: this.disabled}),
                    on: {click: this.onClick}
                }, [t("div", {class: ba("text")}, [this.title, t(ot, {
                    attrs: {dot: this.dot, info: this.info},
                    class: ba("info")
                })])])
            }
        }), ka = Object(r.a)("skeleton"), Sa = ka[0], xa = ka[1], wa = "100%", Ca = "60%";

        function Oa(t, e, i, n) {
            if (!e.loading) return i.default && i.default();
            return t("div", o()([{class: xa({animate: e.animate})}, h(n)]), [function () {
                if (e.avatar) {
                    var i = Object(tt.a)(e.avatarSize);
                    return t("div", {class: xa("avatar", e.avatarShape), style: {width: i, height: i}})
                }
            }(), t("div", {class: xa("content")}, [function () {
                if (e.title) return t("h3", {class: xa("title"), style: {width: Object(tt.a)(e.titleWidth)}})
            }(), function () {
                for (var i, n = [], s = e.rowWidth, o = 0; o < e.row; o++) n.push(t("div", {
                    class: xa("row"),
                    style: {width: Object(tt.a)((i = o, s === wa && i === e.row - 1 ? Ca : Array.isArray(s) ? s[i] : s))}
                }));
                return n
            }()])])
        }
        ...
        Oa.props = {
            ...
            rowWidth: {type: [Number, String, Array], default: wa}
        };
        var Ta = Sa(Oa), $a = Object(r.a)("sku-header"), Ia = $a[0], Ba = $a[1];
        ...
        function ja(t, e, i, n) {
            ...
            return t("div", o()([{class: [Ba(), S]}, h(n)]), [t("div", {
                class: Ba("img-wrap"), on: {
                    click: function () {
                        a.$emit("sku:previewImage", l)
                    }
                }
            }, [t("img", {attrs: {src: l}})]), t("div", {class: Ba("goods-info")}, [i.default && i.default()])])
        }

        ja.props = {sku: Object, goods: Object, skuEventBus: Object, selectedSku: Object};
        var Na = Ia(ja), Aa = Object(r.a)("sku-header-item"), za = Aa[0], La = Aa[1];
        var Ea = za(function (t, e, i, n) {
            return t("div", o()([{class: La()}, h(n)]), [i.default && i.default()])
        }), Da = Object(r.a)("sku-row"), Ma = Da[0], Fa = Da[1];

        function Pa(t, e, i, n) {
            return t("div", o()([{class: [Fa(), S]}, h(n)]), [t("div", {class: Fa("title")}, [e.skuRow.k]), i.default && i.default()])
        }

        Pa.props = {skuRow: Object};
        var Va = Ma(Pa), Ra = {QUOTA_LIMIT: 0, STOCK_LIMIT: 1}, _a = {LIMIT_TYPE: Ra, UNSELECTED_SKU_VALUE_ID: ""},
            Ha = function (t) {
                var e = {};
            ...
            }, Xa = {normalizeSkuTree: Ha, getSkuComb: qa, getSelectedSkuValues: Ya, isAllSelected: Wa, isSkuChoosable: Ua},
            Ka = (0, Object(r.a)("sku-row-item")[0])({
                props: {
                    skuValue: Object,
                    skuKeyStr: String,
                    skuEventBus: Object,
                    ...
                    choosable: function () {
                        return Ua(this.skuList, this.selectedSku, {key: this.skuKeyStr, valueId: this.skuValue.id})
                    }
                }, methods: {
                    onSelect: function () {
            ...
            }), Qa = Object(r.a)("stepper"), Ga = Qa[0], Za = Qa[1];
        ...
        var tl = Ga({
            props: {
                ...
                return Ja(e, this.value) || this.$emit("input", e), {currentValue: e}
            }, computed: {
                minusDisabled: function () {
                    ...
                    var t = {};
                    return this.inputWidth && (t.width = Object(tt.a)(this.inputWidth)), this.buttonSize && (t.height = Object(tt.a)(this.buttonSize)), t
                }, buttonStyle: function () {
                    if (this.buttonSize) {
                        var t = Object(tt.a)(this.buttonSize);
                        return {width: t, height: t}
                    }
                }
            }, watch: {
                value: function (t) {
                    Ja(t, this.currentValue) || (this.currentValue = this.format(t))
                ...
                filter: function (t) {
                    ...
                    if ("" !== e) {
                        ...
                        Ja(e, i) || (t.target.value = i), this.emitChange(i)
                    }
                ...
                return e("div", {class: Za()}, [e("button", o()([{
                    directives: [{name: "show", value: this.showMinus}],
                    style: this.buttonStyle,
                    class: Za("minus", {disabled: this.minusDisabled})
                }, i("minus")])), e("input", {
                    attrs: {
                        type: "number",
                        role: "spinbutton",
                    ...
                    style: this.buttonStyle,
                    class: Za("plus", {disabled: this.plusDisabled})
                }, i("plus")]))])
            }
        }), el = Object(r.a)("sku-stepper"), il = el[0], nl = el[2], sl = Ra.QUOTA_LIMIT, ol = Ra.STOCK_LIMIT, rl = il({
            props: {
                stock: Number,
                skuEventBus: Object,
                skuStockNum: Number,
                ...
                return {currentNum: this.selectedNum, limitType: ol}
            }, watch: {
                ...
                stepperLimit: function () {
                    ...
                    return this.quota > 0 && e <= this.stock ? (t = e < 0 ? 0 : e, this.limitType = sl) : (t = this.stock, this.limitType = ol), t
                }
            }, methods: {
                ...
                var t = this, e = arguments[0];
                return e("div", {class: "van-sku-stepper-stock"}, [e("div", {class: "van-sku-stepper-container"}, [e("div", {class: "van-sku__stepper-title"}, [this.stepperTitle || nl("num")]), e(tl, {
        ...
        var cl = /\.(jpeg|jpg|gif|png|svg|webp|jfif|bmp|dpg)/i;

        function hl(t) {
            return !!t.isImage || (t.file && t.file.type ? 0 === t.file.type.indexOf("image") : t.url ? (e = t.url, cl.test(e)) : !!t.content && 0 === t.content.indexOf("data:image"));
            var e
        }

        var dl = Object(r.a)("uploader"), fl = dl[0], pl = dl[1], ml = fl({
            inheritAttrs: !1,
            model: {prop: "fileList"},
            props: {
                disabled: Boolean,
            ...
            computed: {
                previewSizeWithUnit: function () {
                    return Object(tt.a)(this.previewSize)
                }
            },
            methods: {
                getDetail: function (t) {
                    ...
                    } else ul(t, this.resultType).then(function (n) {
                        var s = {file: t};
                        n && (s.content = n), e.onAfterRead(s, i)
                    })
                }, onAfterRead: function (t, e) {
                    e ? this.$emit("oversize", t, this.getDetail()) : (this.resetInput(), this.$emit("input", [].concat(this.fileList, ll(t))), this.afterRead && this.afterRead(t, this.getDetail()))
                    ...
                    var i = this, n = this.$createElement, s = n(pt, {
                        attrs: {name: "clear"}, class: pl("preview-delete"), on: {
                            click: function (n) {
                    ...
                    }), n("div", {class: [pl("file-name"), "van-ellipsis"]}, [t.file ? t.file.name : t.url])]);
                    return n("div", {
                        class: pl("preview"), on: {
                            click: function () {
                    ...
                    if (!(this.fileList.length >= this.maxCount)) {
                        var e, i = this.slots(), s = t("input", {
                            attrs: n({}, this.$attrs, {
                                ...
                                accept: this.accept,
                                disabled: this.disabled
                            }), ref: "input", class: pl("input"), on: {change: this.onChange}
                        });
                        if (i) return t("div", {class: pl("input-wrapper")}, [i, s]);
                        if (this.previewSize) {
                            var o = this.previewSizeWithUnit;
                            e = {width: o, height: o}
                        }
                        return t("div", {class: pl("upload"), style: e}, [t(pt, {
                            attrs: {name: "plus"},
                            class: pl("upload-icon")
                        }), this.uploadText && t("span", {class: pl("upload-text")}, [this.uploadText]), s])
                    }
                }
            },
            render: function () {
                var t = arguments[0];
                return t("div", {class: pl()}, [t("div", {class: pl("wrapper")}, [this.renderPreviewList(), this.renderUpload()])])
            }
        }), vl = Object(r.a)("sku-img-uploader"), gl = vl[0], bl = vl[1], yl = vl[2], kl = gl({
            props: {value: String, uploadImg: Function, maxSize: {type: Number, default: 6}}, data: function () {
                ...
                afterReadFile: function (t) {
                    ...
                    this.$toast(yl("oversize", this.maxSize))
                    ...
                    }, [i("div", {class: bl("img")}, [t])])
                }, renderMask: function () {
                    var t = this.$createElement;
                    return t("div", {class: bl("mask")}, [this.uploadFail ? [t(pt, {
                        attrs: {
                            name: "warning-o",
                            size: "20px"
                        }
                        ...
                        class: bl("warn-text"),
                        domProps: {innerHTML: yl("fail")}
                    })] : t(Ot, {attrs: {type: "spinner", size: "20px", color: "white"}})])
                }
            }, render: function () {
                var t = this, e = arguments[0];
                return e("div", {class: bl()}, [this.value && this.renderUploader([e("img", {attrs: {src: this.value}}), e(pt, {
                    attrs: {name: "clear"},
                    class: bl("delete"),
                    on: {
                        click: function () {
                ...
                })], !0), this.paddingImg && this.renderUploader([e("img", {attrs: {src: this.paddingImg}}), this.renderMask()], !this.uploadFail), !this.value && !this.paddingImg && this.renderUploader(e("div", {class: bl("trigger")}, [e(pt, {
                    attrs: {
                        name: "photograph",
                        size: "22px"
                    }
        ...
        }), Sl = Object(r.a)("sku-messages"), xl = Sl[0], wl = Sl[1], Cl = Sl[2], Ol = xl({
            props: {
                messages: {
                    type: Array, default: function () {
                        return []
                ...
                resetMessageValues: function (t) {
                    ...
                    return t.placeholder || i[e] || Cl("placeholder." + e)
                }, validateMessages: function () {
                    for (var t = this.messageValues, e = 0; e < t.length; e++) {
                        var i = t[e].value, n = this.messages[e];
                        if ("" === i) {
                            if ("1" === String(n.required)) return Cl("image" === n.type ? "upload" : "fill") + n.name
                        } else {
                            if ("tel" === n.type && !Object(Cs.b)(i)) return Cl("invalid.tel");
                            if ("mobile" === n.type && !/^\d{6,20}$/.test(i)) return Cl("invalid.mobile");
                            if ("email" === n.type && !al(i)) return Cl("invalid.email");
                            if ("id_no" === n.type && (i.length < 15 || i.length > 18)) return Cl("invalid.id_no")
                        }
                    }
                }
            }, render: function () {
                ...
                return e(Vi, {
                    ...
                    return "image" === i.type ? e(se, {
                        class: wl("image-cell"),
                        attrs: {
                            "value-class": wl("image-cell-value"),
                            label: Cl("imageLabel"),
                            title: i.name,
        ...
        }), Tl = Object(r.a)("sku-actions"), $l = Tl[0], Il = Tl[1], Bl = Tl[2];
        ...
        function jl(t, e, i, n) {
            ...
            return t("div", o()([{class: Il()}, h(n)]), [e.showAddCartBtn && t(Te, {
                attrs: {
                    size: "large",
                    type: "warning",
                    text: e.addCartText || Bl("addCart")
                }, on: {click: s("sku:addCart")}
            }), t(Te, {
                attrs: {size: "large", type: "danger", text: e.buyText || Bl("buy")},
                on: {click: s("sku:buy")}
            })])
        }

        jl.props = {buyText: String, addCartText: String, skuEventBus: Object, showAddCartBtn: Boolean};
        var Nl = $l(jl), Al = Object(r.a)("sku"), zl = Al[0], Ll = Al[1], El = Al[2], Dl = Ra.QUOTA_LIMIT, Ml = zl({
            props: {
                sku: Object,
                priceTag: String,
                goods: Object,
                ...
                skuGroupClass: function () {
                    ...
                    return Wa(this.sku.tree, this.selectedSku)
                }, isSkuEmpty: function () {
                    return 0 === Object.keys(this.sku).length
                }, hasSku: function () {
                    return !this.sku.none_sku
                }, selectedSkuComb: function () {
                    return this.hasSku ? this.isSkuCombSelected ? qa(this.sku.list, this.selectedSku) : null : {
                        id: this.sku.collection_id,
                        price: Math.round(100 * this.sku.price),
                        stock_num: this.sku.stock_num
                    }
                }, selectedSkuValues: function () {
                    return Ya(this.skuTree, this.selectedSku)
                }, price: function () {
                    ...
                    return e ? e(this.stock) : [El("stock") + " ", t("span", {class: Ll("stock-num", {highlight: this.stock < this.stockThreshold})}, [this.stock]), " " + El("stockUnit")]
                }, quotaText: function () {
                    var t = this.customStepperConfig, e = t.quotaText;
                    if (t.hideQuotaText) return "";
                    var i = "";
                    return e ? i = e : this.quota > 0 && (i = El("quotaLimit", this.quota)), i
                }, selectedText: function () {
                    var t = this;
                    if (this.selectedSkuComb) return El("selected") + " " + this.selectedSkuValues.map(function (t) {
                        return t.name
                    }).join("；");
                ...
                resetStepper: function () {
                    ...
                    this.selectedSku = {}, t.forEach(function (t) {
                        ...
                        1 === t.v.length && Ua(e.sku.list, e.selectedSku, {
                            key: i,
                            valueId: n
                        }) && (e.selectedSku[i] = n)
                    });
                    ...
                    if (0 === this.selectedNum) return El("unavailable");
                    ...
                    if (o) o(t); else if ("minus" === e) Se(El("minusTip")); else if ("plus" === e) if (i === Dl) {
                        var r = El("quotaLimit", n);
                        s > 0 && (r += "，" + El("quotaCount", s)), Se(r)
                    } else Se(El("soldout"))
                }, onAddCart: function () {
        ...
        }), Ml.SkuActions = Nl, Ml.SkuHeader = Na, Ml.SkuHeaderItem = Ea, Ml.SkuMessages = Ol, Ml.SkuStepper = rl, Ml.SkuRow = Va, Ml.SkuRowItem = Ka, Ml.skuHelper = Xa, Ml.skuConstants = _a;
        var Fl = Ml, Pl = Object(r.a)("slider"), Vl = Pl[0], Rl = Pl[1], _l = Vl({
            mixins: [T],
            props: {
                disabled: Boolean,
                vertical: Boolean,
            ...
            render: function () {
                var t, e = arguments[0], i = this.vertical, n = {background: this.inactiveColor},
                    ...
                    r = ((t = {})[s] = 100 * (this.value - this.min) / this.range + "%", t[o] = Object(tt.a)(this.barHeight), t.background = this.activeColor, t);
                return this.dragStatus && (r.transition = "none"), e("div", {
                    style: n,
                    class: Rl({disabled: this.disabled, vertical: i}),
                    on: {click: this.onClick}
                }, [e("div", {class: Rl("bar"), style: r}, [e("div", {
                    attrs: {
                        role: "slider",
                ...
                }, [this.slots("button") || e("div", {class: Rl("button")})])])])
            }
        }), Hl = Object(r.a)("step"), Wl = Hl[0], ql = Hl[1], Yl = Wl({
            mixins: [ri("vanSteps")], computed: {
                status: function () {
                ...
                genCircle: function () {
                    var t = this.$createElement, e = this.parent, i = e.activeIcon, n = e.activeColor,
                        s = e.inactiveIcon;
                    if ("process" === this.status) return this.slots("active-icon") || t(pt, {
                        class: ql("icon"),
                ...
                var t, e = arguments[0], i = this.status, n = this.parent, s = n.activeColor, o = n.direction,
                    r = "process" === i && {color: s};
                return e("div", {class: [b, ql([o, (t = {}, t[i] = i, t)])]}, [e("div", {
                    class: ql("title"),
                    style: r
                }, [this.slots()]), e("div", {class: ql("circle-container")}, [this.genCircle()]), e("div", {class: ql("line")})])
            }
        }), Ul = Object(r.a)("steps"), Xl = Ul[0], Kl = Ul[1], Ql = Xl({
            mixins: [ai("vanSteps")],
            props: {
                inactiveIcon: String,
        ...
        }), Gl = Object(r.a)("submit-bar"), Zl = Gl[0], Jl = Gl[1], tu = Gl[2];

        function eu(t, e, i, n) {
            var s = e.tip, r = e.price, a = e.tipIcon;
            return t("div", o()([{class: Jl({"safe-area-inset-bottom": e.safeAreaInsetBottom})}, h(n)]), [i.top && i.top(), function () {
                if (i.tip || s) return t("div", {class: Jl("tip")}, [a && t(pt, {
                    class: Jl("tip-icon"),
                    attrs: {name: a}
                }), s && t("span", {class: Jl("tip-text")}, [s]), i.tip && i.tip()])
            }(), t("div", {class: Jl("bar")}, [i.default && i.default(), function () {
                if ("number" == typeof r) {
                    var i = e.currency + " " + (r / 100).toFixed(e.decimalLength);
                    return t("div", {class: Jl("text")}, [t("span", [e.label || tu("label")]), t("span", {class: Jl("price")}, [i]), e.suffixLabel && t("span", {class: Jl("suffix-label")}, [e.suffixLabel])])
                }
            }(), t(Te, {
                attrs: {
                    square: !0,
        ...
        var iu = Zl(eu), nu = Object(r.a)("swipe-cell"), su = nu[0], ou = nu[1], ru = su({
            mixins: [T, qs({event: "touchstart", method: "onClick"})],
            props: {
                onClose: Function,
                disabled: Boolean,
                leftWidth: Number,
            ...
            methods: {
                getWidthByRef: function (t) {
                    ...
                    void 0 === t && (t = 0), this.offset = Et(t, -this.computedRightWidth, this.computedLeftWidth), this.offset ? this.swiping = !0 : this.opened = !1
        ...
        }), au = Object(r.a)("tabbar"), lu = au[0], uu = au[1], cu = lu({
            mixins: [ai("vanTabbar")],
            props: {
                route: Boolean,
                activeColor: String,
            ...
            render: function () {
                ...
                return e("div", {
                    style: {zIndex: this.zIndex},
                    class: [(t = {}, t[w] = this.border, t), uu({
                        fixed: this.fixed,
                        "safe-area-inset-bottom": this.safeAreaInsetBottom
                    })]
                }, [this.slots()])
            }
        }), hu = Object(r.a)("tabbar-item"), du = hu[0], fu = hu[1], pu = du({
            mixins: [ri("vanTabbar")],
            props: n({}, Jt, {dot: Boolean, icon: String, name: [Number, String], info: [Number, String]}),
            data: function () {
                return {active: !1}
            },
            computed: {
            ...
            methods: {
                onClick: function (t) {
                    this.parent.onChange(this.name || this.index), this.$emit("click", t), Gt(this.$router, this)
                }
            },
            render: function () {
                ...
                return t("div", {
                    ...
                    style: {color: s},
                    on: {click: this.onClick}
                }, [t("div", {class: fu("icon")}, [i("icon", {active: n}) || e && t(pt, {attrs: {name: e}}), t(ot, {
                    attrs: {
                        dot: this.dot,
                        info: this.info
                    }
                })]), t("div", {class: fu("text")}, [i("default", {active: n})])])
            }
        }), mu = Object(r.a)("tree-select"), vu = mu[0], gu = mu[1];
        ...
        function bu(t, e, i, n) {
            ...
            var p = r.map(function (e) {
                return t(ya, {
                    ...
                    class: [gu("nav-item"), e.className]
                })
            });
            return t("div", o()([{class: gu(), style: {height: Object(tt.a)(s)}}, h(n)]), [t(ma, {
                class: gu("nav"),
                attrs: {activeKey: a},
                on: {
                    change: function (t) {
            ...
            }, [p]), t("div", {class: gu("content")}, [i.content ? i.content() : u.map(function (i) {
                return t("div", {
                    key: i.id,
                    class: ["van-ellipsis", gu("item", {active: f(i.id), disabled: i.disabled})],
                    on: {
                        click: function () {
                            if (!i.disabled) {
                                var t = i.id;
                ...
                }, [i.text, f(i.id) && t(pt, {attrs: {name: "checked", size: "16px"}, class: gu("selected")})])
            })])])
        }
        ...
        var ku = "2.2.9",
            Su = [jt, oi, Oi, Kt, Te, Ei, se, Vi, _i, Yi, Ji, sn, ln, fn, yn, On, Nn, Vn, Un, Jn, ws, Es, De, Vs, Ws, Ks, ce, Js, no, ao, ho, vo, pt, ut, zo, Mo, Ro, ot, Xo, Ot, tr, sr, pr, Or, R, Nr, Dr, Rr, qt, bt, qr, Gr, pi, hi, ea, oa, ha, ma, ya, Ta, Fl, _l, Yl, tl, Ql, ps, iu, ko, ru, Co, Xe, Je, ns, cu, pu, bs, ji, Se, yu, ml],
            xu = function (t) {
                Su.forEach(function (e) {
                    t.use(e)
                })
            };
        "undefined" != typeof window && window.Vue && xu(window.Vue);
        e.default = {install: xu, version: ku}
    }])
});